...
export const metadata: Metadata = {
  title: "Spa Near Mohakhali, Dhaka | Relaxing Spa Dhaka",
  description:
    "Looking for a spa near Mohakhali, Dhaka? Relaxing Spa Dhaka on Kamal Ataturk Avenue, Banani is just 7-12 mins away. Serving Mohakhali DOHS & commercial area.",
  alternates: {
    canonical: "https://relaxingspadhaka.com/locations/spa-near-mohakhali/",
  },
  openGraph: {
    title: "Spa Near Mohakhali, Dhaka | Relaxing Spa Dhaka",
    description:
      "Looking for a spa near Mohakhali, Dhaka? Relaxing Spa Dhaka on Kamal Ataturk Avenue, Banani is just 7-12 mins away. Serving Mohakhali DOHS & commercial area.",
    url: "https://relaxingspadhaka.com/locations/spa-near-mohakhali/",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Spa Near Mohakhali Dhaka - Relaxing Spa Dhaka Banani",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Spa Near Mohakhali, Dhaka | Relaxing Spa Dhaka",
    description:
      "Luxury spa near Mohakhali DOHS & Wireless. Located just 7-12 mins away on Kamal Ataturk Avenue, Banani.",
    images: ["https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=1200&auto=format&fit=crop"],
  },
};

export default function SpaNearMohakhaliPage() {
  const breadcrumbs = [
    { name: "Home", url: "https://relaxingspadhaka.com/" },
    { name: "Locations", url: "https://relaxingspadhaka.com/locations/" },
    { name: "Spa Near Mohakhali", url: "https://relaxingspadhaka.com/locations/spa-near-mohakhali/" },
  ];

  const mohakhaliFaqs = [
    {
      question: "How far is the spa from Mohakhali DOHS?",
      answer: "Our physical spa sanctuary on Kamal Ataturk Avenue in Banani is located just 7 to 12 minutes North of Mohakhali DOHS and Mohakhali Wireless gate.",
    },
    {
      question: "What driving route should I take from Mohakhali?",
      answer: "From Mohakhali Wireless, drive North along Airport Road or through Banani Chairmanbari intersection and turn onto Kamal Ataturk Avenue.",
    },
    {
      question: "Do you offer late evening sessions for Mohakhali professionals?",
      answer: "Yes, we are open daily until 11:00 PM, providing convenient evening relaxation after work.",
    },
  ];
  ...
  return (
    <main className="relative min-h-screen bg-[#0B0B0B] text-[#F5F1E8] overflow-x-hidden">
      <JsonLd
        url="https://relaxingspadhaka.com/locations/spa-near-mohakhali/"
        title="Spa Near Mohakhali, Dhaka | Relaxing Spa Dhaka"
        description="Looking for a spa near Mohakhali, Dhaka? Relaxing Spa Dhaka on Kamal Ataturk Avenue, Banani is just 7-12 mins away."
        breadcrumbs={breadcrumbs}
        serviceName="Luxury Spa Therapy for Mohakhali Visitors"
        serviceDescription="Authentic Thai massages, aroma oil therapies, deep tissue bodywork, and private VIP couples suites near Mohakhali."
        faqs={mohakhaliFaqs}
      />
      <Navbar />

      <SubpageHero
        title="Spa Near Mohakhali, Dhaka"
        subtitle="7-12 MINUTES FROM MOHAKHALI DOHS & WIRELESS"
        description="Searching for a high-end spa near Mohakhali? Relaxing Spa Dhaka is located right nearby on Kamal Ataturk Avenue in Banani. Experience authentic Thai bodywork, organic oil massages, and private climate-controlled suites."
        breadcrumbs={breadcrumbs}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div>
                <span className="text-[11px] tracking-[0.35em] text-[#C9A45C] uppercase font-semibold block mb-2">
                  MOHAKHALI WELLNESS PROXIMITY
                </span>
                <h2 className="font-serif text-3xl sm:text-4xl text-[#F5F1E8] mb-4">
                  Looking for a Spa Near Mohakhali?
                </h2>
                <p className="text-base text-[#A8A8A8] font-light leading-relaxed mb-4">
                  Executives, residents, and medical professionals in Mohakhali DOHS and Mohakhali Commercial Area looking for a luxury <strong className="text-[#F5F1E8] font-medium">spa near Mohakhali</strong> can reach our Banani sanctuary in under 10 minutes.
                </p>
                <p className="text-sm text-[#A8A8A8] font-light leading-relaxed">
                  Relaxing Spa Dhaka provides private suites, organic aromatherapy oils, and certified specialists located directly on Kamal Ataturk Avenue.
                </p>
              </div>
              ...
              <div className="bg-[#151515] p-6 rounded-sm border border-[#C9A45C]/30 space-y-3">
                ...
                <p className="text-xs text-[#A8A8A8] font-light leading-relaxed">
                  Please note: Relaxing Spa Dhaka is physically located on Kamal Ataturk Avenue in Banani. We do not claim a physical branch inside Mohakhali, but our close proximity offers easy access for Mohakhali visitors.
                </p>
              </div>

              <div className="space-y-3">
                <h2 className="font-serif text-2xl sm:text-3xl text-[#F5F1E8]">
                  Thai Massage Near Mohakhali
                </h2>
                <p className="text-sm text-[#A8A8A8] font-light leading-relaxed">
                  Enjoy authentic <strong className="text-[#F5F1E8]">Thai massage near Mohakhali</strong>. Our practitioners integrate acupressure point release, joint mobility stretching, and energy line balancing.
                </p>
              </div>

              <div className="space-y-4">
                <h2 className="font-serif text-2xl sm:text-3xl text-[#F5F1E8]">
                  Getting Here from Mohakhali
                </h2>
                <ul className="space-y-2.5 text-xs text-[#A8A8A8] font-light">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 size={16} className="text-[#C9A45C] shrink-0 mt-0.5" />
                    <span><strong>From Mohakhali Wireless / DOHS:</strong> Head North along Airport Road / Chairmanbari toward Banani and turn onto Kamal Ataturk Avenue (7-12 mins).</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 size={16} className="text-[#C9A45C] shrink-0 mt-0.5" />
                    <span><strong>From Mohakhali Flyover:</strong> Take the Banani exit onto Kamal Ataturk Avenue directly.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 space-y-8 sticky top-28">
              <div className="bg-[#151515] p-6 rounded-sm border border-[#C9A45C]/30 shadow-2xl space-y-4">
                ...
                <a
                  href={getWhatsAppUrl("Hello Relaxing Spa Dhaka, I am visiting from Mohakhali and would like to book a session.")}
                  target="_blank"
                ...
                >
                  ...
                  <span>BOOK SESSION FROM MOHAKHALI</span>
                </a>
              </div>
